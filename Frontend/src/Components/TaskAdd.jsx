...
const TaskAdd = (props) => {
    ...
    return (
    <>
    <form onSubmit={onFormSubmit} className={`container w-11/12 lg:w-4/5 mx-auto bg-slate-100 dark:bg-slate-800 border border-solid rounded-lg sm:px-4 sm:py-3 px-3 pb-3 pt-2 flex-auto flex flex-wrap items-center place-content-between border-slate-300 dark:border-slate-600 shadow-md fixed bottom-6 sm:bottom-10 left-0 right-0 transition-all delay-[95ms] duration-800 ease-in-out`}>
