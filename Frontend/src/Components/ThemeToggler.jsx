...
const ThemeToggler = () => {
    ...
    return (
        ...
        :
        (<MoonIcon onClick={()=>{setIsDark(true); toggleTheme(true)}} className="h-7 w-7 text-slate-500 dark:text-slate-400  hover:fill-slate-500 transition-all ease-in-out duration-400" aria-hidden="true"/>)
        }
        </div>
    )
}
